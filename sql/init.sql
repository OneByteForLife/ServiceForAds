...
CREATE TABLE advertisements (
    ...
    product_date_create timestamp not null,
    price decimal(8, 2) not null
);

INSERT INTO advertisements (product_name, product_description, product_main_picture, product_more_pictures, product_date_create, price)
VALUES(
    ...
    '2023-01-28 10:22:34', -- Дата создания
    15000 -- Цена товара
), (
